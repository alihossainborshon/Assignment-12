...
export const TouristProfile = () => {
  ...
  const handleApplyGuide = () => {
    navigate("/dashboard/becomeAGuide");
  };
    ...
    <div className="min-h-screen flex flex-col items-center py-10 px-4">
      ...
      <div className="max-w-4xl w-full mb-6 text-center">
        ...
        <p className="mt-2 text-gray-700 text-lg md:text-xl">
          Manage your profile, view your details and apply to become a tour
          guide.
        </p>
      </div>
      ...
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden transform hover:scale-102 transition-transform duration-300">
        ...
        <div className="flex flex-col items-center -mt-20 px-6 pb-8">
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-4">
            ...
            {role === "tourist" && (
              <button
                className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-400 to-green-600 text-white font-semibold rounded-xl shadow-lg transform transition-all hover:scale-105 hover:from-green-500 hover:to-green-700"
